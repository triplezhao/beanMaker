 ...
 * create by freemaker
 */
public class MyCharityBeanProvider extends BaseProvider {
    public static final String AUTHORITY = "com.frame.rrbang.db.MyCharityBeanProvider";
    public static final String TABLE_PATH = "MyCharityBeanTB";
